    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-2xl font-bold tracking-tighter flex flex-row items-center">
            <span
              className="bg-clip-text text-transparent bg-gradient-to-l from-[#0066cc] via-[#0160c0] to-[#0f9fff]"
              //   {cn(
              //   isDarkMode
            ...
            <span className="bg-clip-text text-transparent bg-red-500">AI</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          <button
            ...
            className={cn(
              ...
              isMenuOpen ? "rotate-90 bg-blue-500/10" : "rotate-0",
              isDarkMode
        ...
        >
          <div className="p-6 space-y-6">
                ...
                >
                  <span
                    className={cn(
                      ...
                      isDarkMode ? "left-7 bg-blue-300" : "left-1 bg-blue-600"
                    )}
                  ></span>
                </button>
              </div>
            ...
            <div className="pt-6 border-t border-blue-500/10">
              ...
              >
                Discover the tools and resources available to our community
                members.
              </p>
            </div>
          </div>
